        ...
        <div id="sf_admin_form_container">
            <div id="sf_admin_content">
                <h2>My Qualifications
                    <span class="actions">
                        <a href="/backend.php/profile_qualification/new" id="add_profile_qualications">Add</a>
                    </span>
                </h2>
                <div id="qualifications_list"></div>
                <h2>My Awards
                    <span class="actions">
                        <a href="/backend.php/profile_award/new" id="add_profile_awards">Add</a>
                    </span>
                </h2>
...
<script type="text/javascript">
    ...
    function fetchProfileQualifications(){  
        $("#qualifications_list").load("/backend.php/profile_qualifications");            
    }
        
    function fetchProfileAwards(){  
        $("#awards_list").load("/backend.php/profile_awards");            
    }
</script>