...
class activity_feedGeneratorHelper extends BaseActivity_feedGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_done">' . link_to(__($params['label'], array(), 'sf_admin'), $params['redirect_url'], array("popup_url" => "/backend.php/activity_feed" . $object->getId() . "/edit")) . '</li>';
    }
