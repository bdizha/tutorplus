...
class applicationGeneratorHelper extends BaseApplicationGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/application#", array()).'</li>';
  }

  public function linkToEdit($object, $params)
  {
    return '<li class="sf_admin_action_edit">'.link_to(__($params['label'], array(), 'sf_admin'), "/backend.php/application#", array("popup_url" => "/backend.php/application/".$object->getId()."/edit")).'</li>';
  }
