            ...
            <div id="student_attendance" class="sf_admin_show">
                ...
                <ul class="sf_admin_actions" style="clear:both">
                    <li class="sf_admin_action_new">
                        <input type="button" onclick="document.location.href='/backend.php/attendance';" value="< Course Attendance">
                    </li>
                    <li class="sf_admin_action_new">
                        <input type="button" value="Save Attendance" class="save"/>
                    </li>
                    <li class="sf_admin_action_new">
                        <input type="button" onclick="document.location.href='/backend.php/course/<?php echo $attendance->getCourse()->getId() ?>'" value="< My Course">
                    </li>
                </ul>
                </form>
            </div>
