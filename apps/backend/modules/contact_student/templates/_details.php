...
<div class="content-block">    
    <div class="left-block">
        <h2>Physical Address <span class="actions"><a href="/backend.php/contact_student_edit/physical_address" id="edit_physical_address">Edit</a></span></h2>
    ...
    <div class="right-block">    
        <h2>Postal Address <span class="actions"><a href="/backend.php/contact_student_edit/postal_address" id="edit_postal_address">Edit</a></span></h2>
    ...
    <div class="content-block">    
        <h2>Guardian Address <span class="actions"><a href="/backend.php/contact_student_edit/guardian_details" id="edit_guardian_details">Edit</a></span></h2>
