        ...
        <?php foreach ($correspondence_suggestions as $correspondence_suggestion): ?>
            <li id="suggested_correspondent_<?php echo $correspondence_suggestion['id'] ?>">
                ...
                <div class="correspondent-show">
                    ...
                    <a class="decline" decline_id="<?php echo $correspondence_suggestion['id'] ?>" href="/backend.php/correspondence_suggestions/<?php echo $correspondence_suggestion['id'] ?>/2">Decline</a>
                    <a class="accept" accept_id="<?php echo $correspondence_suggestion['id'] ?>" href="/backend.php/correspondence_suggestions/<?php echo $correspondence_suggestion['id'] ?>/0">Add correspondent</a>
                </div>
            </li>
        <?php endforeach; ?>
        <div class="clear"></div>
