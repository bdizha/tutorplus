...
<div id="sf_admin_form_container">
    <div id="sf_admin_form_content">
        <div class="sf_admin_form">
            <form id="student_correspondent_form" enctype="multipart/form-data" action="/backend.php/correspondent_correspond" method="post">
                    ...
                    <li id="found_correspondent_<?php echo $id ?>">
                        ...
                        <div class="correspondent-show">
                            ...
                            <?php if (!is_array($correspondent)): ?>
                                <a class="correspond" correspond_id="<?php echo $id ?>" href="/backend.php/correspondence_correspond/<?php echo $id ?>">Correspond</a>
                            <?php else: ?>
                                <?php if ($correspondent["is_request"] === true): ?>
                                    <a class="decline" decline_id="<?php echo $correspondent["id"] ?>" href="/backend.php/correspondence_requests/<?php echo $correspondent["id"] ?>/2">Decline</a>
                                    <a class="accept" accept_id="<?php echo $correspondent["id"] ?>" href="/backend.php/correspondence_requests/<?php echo $correspondent["id"] ?>/1">Accept request</a>
                                <?php else: ?>
