...
<div id="sf_admin_content">    
    ...
    <div class="content-block">
                    ...
                    <ul>
                        <li id="found_correspondent_26">
                            ...
                            <div class="correspondent-show">
                                ...
                                <a class="correspond" correspond_id="26" href="/backend.php/correspondence_correspond/26">Correspond</a>
                            </div>
                        </li>
        ...
        <div class="correspond-right-block" style="width: 260px;">
            <h2>Peer Requests
                <span class="actions">
                    <a href="/backend.php/correspondent_correspond" class="add_correspondent">Invite</a>
                </span>
            </h2>
