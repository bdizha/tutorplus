...
<?php include_component('common', 'menu', array("current_parent" => "courses", "current_child" => "courses", "current_link" => "my_courses")) ?>
<?php end_slot() ?>

<?php slot('breadcrumbs') ?>
<?php include_partial('common/breadcrumbs', array('breadcrumbs' => array("My Courses" => "courses"))) ?>
<?php end_slot() ?>
