...
<?php include_partial('common/breadcrumbs', array('breadcrumbs' => array("Academics" => "academic", "Academic Settings" => "academic_settings", "Courses" => "course", "New Course" => "course_new"))) ?>
<?php end_slot() ?>

<?php include_partial('course/flashes', array('form' => $form)) ?>
<div class="sf_admin_heading">
    <h3><?php echo __('New Course', array(), 'messages') ?></h3>
</div>
