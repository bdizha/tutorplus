...
class course_announcementGeneratorHelper extends BaseCourse_announcementGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">' . button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/course_announcement#", array("class" => "new")) . '</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<a class="edit" href="/backend.php/course_announcement/' . $object->getId() . '/edit">&nbsp;</a>';
    }
    ...
    {
        return '<input class="cancel" type="button" ' . '" onclick="document.location.href=\'/backend.php/course_announcement\'" value="Cancel"/>';
    }

    public function linkToDone($object, $params)
    {
        return '<input class="done" type="button" ' . '" onclick="document.location.href=\'/backend.php/course_announcement\'" value="Done"/>';
    }
