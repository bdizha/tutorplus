<ul class="sf_admin_actions">
    <?php if ($form->isNew()): ?>
        <li class="sf_admin_action_cancel">
            ...
            <?php else: ?>
                <?php echo link_to(__('Cancel', array(), 'messages'), 'course_meeting_time/ListCancel?id=' . $course_meeting_time->getId(), array()) ?>
            <?php endif; ?>
        </li>
    ...
    <?php else: ?>
        ...
        <li class="sf_admin_action_done">
            ...
            <?php else: ?>
                <?php echo link_to(__('Done', array(), 'messages'), 'course_meeting_time/ListDone?id=' . $course_meeting_time->getId(), array()) ?>
            <?php endif; ?>
        </li>
        <?php echo $helper->linkToSave($form->getObject(), array('params' => array(), 'class_suffix' => 'save', 'label' => 'Save',)) ?>
    <?php endif; ?>
...
<script type='text/javascript'>
    $(document).ready(function(){        
        $("#course_meeting_time_form_holder .cancel, #course_meeting_time_form_holder .done").click(function(){
            $.fn.colorbox.close();
            return false;
        });
