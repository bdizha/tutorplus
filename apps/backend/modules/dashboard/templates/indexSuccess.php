...
<div id="sf_admin_content">
    <div id="dashboard_container">
        <div class="content-block dashboard-block left">
            <h2>Notifications <a href="/backend.php/activity_feed" class="view-more"></a></h2>
        ...
        <div class="content-block dashboard-block left">
            <h2>My Courses <a href="/backend.php/courses" class="view-more"></a></h2>
            <div id="my_courses" class="dashboard-row">
                <?php include_partial('courses', array('myCourses' => $courses)) ?>
            </div>
        </div>
        <div class="content-block dashboard-block">
            <h2>My Discussions <a href="/backend.php/discussion" class="view-more"></a></h2>
            <div id="my_discussions" class="dashboard-row">
                <?php include_partial('discussions', array('myDiscussions' => $discussions)) ?>
            </div>
        </div>
        <div class="content-block dashboard-block left">
            <h2>Announcements <a href="/backend.php/announcement" class="view-more"></a></h2>
