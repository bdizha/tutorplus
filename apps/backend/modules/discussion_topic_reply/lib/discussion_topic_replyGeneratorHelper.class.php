...
class discussion_topic_replyGeneratorHelper extends BaseDiscussion_topic_replyGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/discussion_topic_reply#", array()).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__($params['label'], array(), 'sf_admin'), "/backend.php/discussion_topic_reply#", array("popup_url" => "/backend.php/discussion_topic_reply/".$object->getId()."/edit")).'</li>';
    }
