...
class email_templateGeneratorHelper extends BaseEmail_templateGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/email_template#", array("class" => "new")).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/backend.php/email_template#", array("popup_url" => "/backend.php/email_template/".$object->getId()."/edit")).'</li>';
    }
