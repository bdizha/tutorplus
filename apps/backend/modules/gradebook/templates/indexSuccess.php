...
<script type="text/javascript">
    ...
    function fetchGradebookGrades(){
        ...
        $.get('/backend.php/gradebook/grades', showGradebookGrades);
    }
		
    function fetchGradebookScale(){
        $('#gradebook_scale').html(loadingHtml);        
        $.get('/backend.php/gradebook_scale', showGradebookScale);
    }
		
    function fetchGradebookItems(){
        $('#gradebook_items').html(loadingHtml);
        $.get('/backend.php/gradebook_item', showGradebookItems);
    }		
