...
class instructorGeneratorHelper extends BaseInstructorGeneratorHelper {
    ...
    public function linkToAcademic($object, $params) {
        return '<input class="save" type="button" value="Manage Academic Details" onclick="document.location.href=\'/backend.php/instructor_academic_settings\'"/>';
    }

    public function linkToContact($object, $params) {
        return '<input class="save" type="button" value="Manage Contact Details" onclick="document.location.href=\'/backend.php/instructor_contact/new\'"/>';
    }
