<div id="sf_admin_form_container">
    <form id="mailing_list_form" action="/backend_dev.php/mailing_lists_instructor" method="post">
        ...
        <ul class="sf_admin_actions">
            <li class="sf_admin_action_cancel">
                <a href="/backend.php/contact_instructor/1/List_cancel">Cancel</a>                    
            </li>
            <li class="sf_admin_action_save">
                <input type="button" class="save" value=" Save ">
            </li>       
            <li class="sf_admin_action_done">
                <a href="/backend.php/contact_instructor/1/List_done">Done</a>                   
            </li>
        </ul>
    </form>
</div>
<script type='text/javascript'>
    $(document).ready(function(){	        
        $("#department_faculty_id").change(function(){
            ...
            if(data != null)
            {
                $.getJSON("/backend.php/department_choose", data, reloadDepartments);                    
            }
        });
        ...
        $(".sf_admin_action_save input").click(function(){ 
            $("#mailing_list_form").ajaxSubmit(function(data){
                ...
                $("#mailing_lists_list").load("instructor_mailing_lists");
            });            
            return false;
        });
