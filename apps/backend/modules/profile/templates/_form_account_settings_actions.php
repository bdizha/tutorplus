...
<script type='text/javascript'>
    $(document).ready(function(){
        $("#profile_account_settings_form_holder .save").click(function(){
            $("#cboxLoadedContentInner").hide();
            $("#cboxLoadedContent").append(loadingHtml); 
            
            $("#profile_account_settings_form").ajaxSubmit(function(data){
                $("#cboxLoadedContent").html(data);
                $.fn.colorbox.resize();
                
                // fetch profile account settings
                fetchProfileAccountSettings();
            });       
            return false;
        });        
