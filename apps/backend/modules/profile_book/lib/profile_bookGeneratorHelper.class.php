...
class profile_bookGeneratorHelper extends BaseProfile_bookGeneratorHelper {
    ...
    public function linkToNew($params) {
        return '<li class="sf_admin_action_new">' . button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/profile_book", array()) . '</li>';
    }

    public function linkToEdit($object, $params) {
        return '<li class="sf_admin_action_edit">' . link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/backend.php/profile_book", array("popup_url" => "/backend.php/profile_book/" . $object->getId() . "/edit")) . '</li>';
    }
