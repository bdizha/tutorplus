...
class sfGuardPermissionGeneratorHelper extends BaseSfGuardPermissionGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/sfGuardPermission#", array()).'</li>';
  }

  public function linkToEdit($object, $params)
  {
    return '<li class="sf_admin_action_edit">'.link_to(__($params['label'], array(), 'sf_admin'), "/backend.php/sfGuardPermission#", array("popup_url" => "/backend.php/sfGuardPermission/".$object->getId()."/edit")).'</li>';
  }
