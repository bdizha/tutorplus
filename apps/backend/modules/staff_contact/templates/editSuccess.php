...
<?php include_partial('common/breadcrumbs', array('breadcrumbs' => array("Academics" => "staff", "staffs" => "staff", __('Edit Contact Details ~ %%first_name%% %%last_name%%', array('%%first_name%%' => $staff->getFirstName(), '%%last_name%%' => $staff->getLastName()), 'messages') => "staff_contact/" . $staff_contact->getId() . "/"))) ?>
<?php end_slot() ?>

<?php include_partial('staff_contact/flashes', array('form' => $form)) ?>
<div class="sf_admin_heading">
    <h3><?php echo __('Edit Contact Details ~ %%first_name%% %%last_name%%', array('%%first_name%%' => $staff->getFirstName(), '%%last_name%%' => $staff->getLastName()), 'messages') ?></h3>
</div>
