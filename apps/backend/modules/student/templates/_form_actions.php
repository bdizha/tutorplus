<ul class="sf_admin_actions" id="sf_admin_actions_<?php echo $this->getModuleName() ?>">
    <?php if ($form->isNew()): ?>
        <li class="sf_admin_action_cancel">
            ...
            <?php else: ?>
                <?php echo link_to(__('Cancel', array(), 'messages'), 'student/ListCancel?id=' . $student->getId(), array()) ?>
            <?php endif; ?>
        </li>
    ...
    <?php else: ?>
        ...
        <li class="sf_admin_action_done">
            ...
            <?php else: ?>
                <?php echo link_to(__('Done', array(), 'messages'), 'student/ListDone?id=' . $student->getId(), array()) ?>
            <?php endif; ?>
        </li>
