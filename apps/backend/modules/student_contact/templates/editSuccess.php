...
<?php include_partial('common/breadcrumbs', array('breadcrumbs' => array("Academics" => "student", "Students" => "student", __('Edit Contact Details ~ %%first_name%% %%last_name%%', array('%%first_name%%' => $student->getFirstName(), '%%last_name%%' => $student->getLastName()), 'messages') => "student_contact/" . $student_contact->getId() . "/"))) ?>
<?php end_slot() ?>

<?php include_partial('student_contact/flashes', array('form' => $form)) ?>
<div class="sf_admin_heading">
    <h3><?php echo __('Edit Contact Details ~ %%first_name%% %%last_name%%', array('%%first_name%%' => $student->getFirstName(), '%%last_name%%' => $student->getLastName()), 'messages') ?></h3>
</div>
