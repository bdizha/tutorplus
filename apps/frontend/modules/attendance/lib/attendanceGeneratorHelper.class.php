...
class attendanceGeneratorHelper extends BaseAttendanceGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/attendance#", array()).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__($params['label'], array(), 'sf_admin'), "/attendance#", array("popup_url" => "/attendance/".$object->getId()."/edit")).'</li>';
    }
