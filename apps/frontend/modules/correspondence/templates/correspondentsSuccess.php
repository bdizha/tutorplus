    ...
    <div id="sf_admin_content">
            ...
            <div class="correspondents_row">
                <?php foreach ($my_correspondents as $correspondent): ?>
                    ...
                    <div class="corresponden_col <?php echo (fmod($i, 4) == 1) ? 'first' : '' ?>">
                        ...
                        <div class="user_name"><a href="/profile"><?php echo $correspondent->getCorrespondent() ?></a></div>
                        <div class="email_user">&nbsp;</div>
                        <div class="remove_user" id="/correspondence/<?php echo $correspondent->getId() ?>" alt="remove" title="remove">&nbsp;</div>
                    </div>          
                <?php endforeach; ?>
            </div>
        </div>
        <div id="invite_correspondents_content">
            ...
            <div class="content" id="correspondents">  
                ...
                <form method="post" action="/correspondence" enctype="multipart/form-data" style="" id="remove_correspondents_form" style="clear: both">
