        ...
        <?php foreach ($requested_correspondences as $correspondence): ?>
            <li id="requesting_correspondent_<?php echo $correspondence->getInnitiatorId() ?>">
                ...
                <div class="correspondent-show">
                    ...
                    <a class="decline" decline_id="<?php echo $correspondence->getInnitiatorId() ?>" href="/correspondence_requests/<?php echo $correspondence->getInnitiatorId() ?>/2">Decline</a>
                    <a class="accept" accept_id="<?php echo $correspondence->getInnitiatorId() ?>" href="/correspondence_requests/<?php echo $correspondence->getInnitiatorId() ?>/1">Accept request</a>
                </div>
            </li>
        <?php endforeach; ?>
        <div class="clear"></div>
