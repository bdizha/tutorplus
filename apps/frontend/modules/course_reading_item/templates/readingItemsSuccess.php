    ...
    <div class="content-row">
        <div class="course-reading-item">
            ...
            <span class="edit-link">
                <a class="course_reading_item_edit" popup_url="/course_reading_item/<?php echo $course_reading_item->getId() ?>/edit" href="/course_reading_item/<?php echo $course_reading_item->getId() ?>/edit">Edit</a>
            </span>
        </div>
    </div>
<?php endforeach; ?>
