...
<div class="discussion_topic plain-row">
    ...
    <div class="user_meta">By <?php echo link_to($discussion_topic->getUser(), 'profile_show', $discussion_topic->getUser()) ?> - <span class="datetime"><?php echo myToolkit::dateInWords($discussion_topic->getUpdatedAt()) ?></span> - <a href="/discussion_topic/<?php echo $discussion_topic->getId() ?>"><?php echo $discussion_topic->getNbReplies($sf_user->getId()) ?> new replies of <?php echo $discussion_topic->getNbMessages() ?> messages</a></div>
