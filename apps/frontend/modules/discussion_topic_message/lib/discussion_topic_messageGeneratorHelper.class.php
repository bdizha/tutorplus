...
class discussion_topic_messageGeneratorHelper extends BaseDiscussion_topic_messageGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/discussion_topic_message", array()).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/discussion_topic_message#", array("popup_url" => "/discussion_topic_message/".$object->getId()."/edit")).'</li>';
    }
    ...
    {
        return '<input class="cancel" type="button" onclick="document.location.href=\'/discussion_topic_message\' value="Cancel"/>';
    }
