...
class documentGeneratorHelper extends BaseDocumentGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/document#", array()).'</li>';
  }

  public function linkToEdit($object, $params)
  {
    return '<li class="sf_admin_action_edit">'.link_to(__($params['label'], array(), 'sf_admin'), "/document#", array("popup_url" => "/document/".$object->getId()."/edit")).'</li>';
  }
