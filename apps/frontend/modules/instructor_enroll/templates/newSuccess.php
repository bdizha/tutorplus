...
<div id="tp_admin_container">
  ...
  <div id="tp_admin_content">
    <div class="left-block">
      <?php include_partial('instructor_enroll/flashes', array('form' => $form)) ?>
      <div id="sf_admin_form_container">
        <div id="sf_admin_content">
          <?php include_partial('instructor_enroll/form', array('profile' => $profile, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
        </div>
        <div id="sf_admin_footer">
          <?php include_partial('instructor_enroll/form_footer', array('profile' => $profile, 'form' => $form, 'configuration' => $configuration)) ?>
        </div>
      </div>
    </div>
