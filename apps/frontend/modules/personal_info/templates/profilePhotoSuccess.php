<div class="content-block">    
    ...
    <div id="profile_picture_container">
        <div class="profile_row">    
            <div id="photo-left">
                <div id="photo">
                    <img src="/profile_show_photo/<?php echo $sf_user->getId() ?>/128/<?php echo time() ?>" alt="<?php echo $sf_user->getName() ?>" title="<?php echo $sf_user->getName() ?>"/>
                </div>
                <?php if ($sf_user->hasPhoto()): ?>
                    <div id="photo-delete">
                        <a href="/profile_delete_photo" onclick="if (confirm('Are you sure?'))return true; else return false;">Delete Photo</a>
                    </div>
                <?php endif; ?>
            </div>
            <div id="photo-right">                
