                ...
                <?php foreach ($student_correspondents as $student_correspondent): ?>
                    <li>
                        <div>
                            ...
                            <div class="user_name"><a href="/profile"><?php echo $student_correspondent->getCorrespondent() ?></a></div>
                        </div>
                    </li>                
                <?php endforeach; ?>
            </ul>
            <div class="view-all view_all_correspondents">
                <a href="/correspondence/correspondents">View all</a>
            </div>
        </div>
                ...
                <?php foreach ($instructor_correspondents as $instructor_correspondent): ?>
                    <li>
                        <div>
                            ...
                            <div class="user_name"><a href="/profile"><?php echo $instructor_correspondent->getCorrespondent() ?></a></div>
                        </div>
                    </li>                
                <?php endforeach; ?>
            </ul>
    ...
    $(document).ready(function(){
        ...
        $(".suggestion-request input").click(function(){
            $("#profile_suggestions").load('/correspondence_request/' + this.id);
        });
        ...
        $(".tabs").live("click", function(){
            ...
            $("#tab_content").load('/' + this.id);
            return false;
        });        
           
        $("#invite_correspondence").click(function(){            
            $("#invite_correspondents_popup").load("/correspondence");
            $("#invite_correspondents_popup").dialog("open");
        });      
           
        $(".view_all_correspondents a").click(function(){            
            $("#view_all_correspondents_popup").load("/correspondence/correspondents");
    ...
    {
        $("#tab_content").load('/bulletin_board_tab');
    }