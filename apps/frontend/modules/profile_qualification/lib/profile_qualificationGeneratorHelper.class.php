...
class profile_qualificationGeneratorHelper extends BaseProfile_qualificationGeneratorHelper {
    ...
    public function linkToNew($params) {
        return '<li class="sf_admin_action_new">' . button_to(__($params['label'], array(), 'sf_admin'), "/profile_qualification", array()) . '</li>';
    }

    public function linkToEdit($object, $params) {
        return '<li class="sf_admin_action_edit">' . link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/profile_qualification", array("popup_url" => "/profile_qualification/" . $object->getId() . "/edit")) . '</li>';
    }
