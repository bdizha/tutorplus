    ...
    <div class="landing-left-column">
        <div class="column-row">
            <p class="welcome-message">
                ...
                <span>collaborate</span> within their module/course activities with the support of our specially trained
                instructors and tutors. It's surely an enhanced free learning platform which is specifically designed to
                compliment your distant educational needs. <span>Get better results with us!!!</span>
            </p>
        </div>
        <div class="column-row">
            ...
            <div class="instructor-testimonial">
                ...
                <div class="text">
                    ...
                    <p class="says">
                        We were very happy with TutorPlus in our first online course so I'd give it a strong positive recommendation
                    </p>
                </div>
            </div>
        </div>
