...
class sfGuardUserGeneratorHelper extends BaseSfGuardUserGeneratorHelper {
    ...
    public function linkToNew($params) {
        return '<li class="sf_admin_action_new">' . button_to(__($params['label'], array(), 'sf_admin'), "/sfGuardUser#", array()) . '</li>';
    }

    public function linkToEdit($object, $params) {
        return '<li class="sf_admin_action_edit">' . link_to(__($params['label'], array(), 'sf_admin'), "/sfGuardUser#", array("popup_url" => "/sfGuardUser/" . $object->getId() . "/edit")) . '</li>';
    }
