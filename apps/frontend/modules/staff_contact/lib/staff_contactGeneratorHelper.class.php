...
class staff_contactGeneratorHelper extends BaseStaff_contactGeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/staff_contact", array()).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/staff_contact", array("popup_url" => "/staff_contact/".$object->getId()."/edit")).'</li>';
    }
    ...
    {
        return '<li class="sf_admin_action_done">' . link_to(__($params['label'], array(), 'sf_admin'), $params['redirect_url'], array("popup_url" => "/staff_contact" . $object->getId() . "/edit")) . '</li>';
    }
