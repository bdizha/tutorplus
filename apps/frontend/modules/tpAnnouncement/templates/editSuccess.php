...
<?php include_component('common', 'secureMenu', $helper->getEditLinks($announcement)) ?>
<?php include_partial('common/breadcrumbs', $helper->getEditBreadcrumbs($announcement)) ?>
...
<div id="sf_admin_content">
	<div class="content-block">
		<?php include_partial('common/tabs', array('tabs' => $helper->getTabs($announcements, $newsItems, "edit", $announcement))) ?>
		<div class="tab-block">
