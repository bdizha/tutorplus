...
<?php include_partial('tpCommon/nav_vertical_secondary', array("item_level_1" => "dashboard_course", "item_level_2" => "course_home", "Course Home", "current_route" => "attendance")) ?>
<?php end_slot() ?>

<?php slot('breadcrumbs') ?>
<?php include_partial('tpCommon/breadcrumbs', array('breadcrumbs' => array("Dashboard" => "dashboard", "My Courses" => "my_courses", "Course ~ "  . $course->getCode() => "course/" . $course->getId(), "Attendance" => "attendance"))) ?>
<?php end_slot() ?>
