...
<div id="sf_admin_form_container">
    <div id="sf_admin_content">
        <div class="content-block">
            <?php include_partial('tpCommon/tabs', $helper->getTabs($course, "edit", $announcement)) ?>
            <div class="tab-block">
                <?php include_partial('tpCourseAnnouncement/form', array('announcement' => $announcement, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
                <div id="sf_admin_footer">
                    <?php include_partial('tpCourseAnnouncement/form_footer', array('announcement' => $announcement, 'form' => $form, 'configuration' => $configuration)) ?>
                </div>
            </div>
        </div>
    </div>
