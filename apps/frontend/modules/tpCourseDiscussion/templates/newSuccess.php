...
<div id="sf_admin_form_container">
    <div id="sf_admin_content">
        <div class="content-block">
            <?php include_partial('tpCommon/tabs', array('tabs' => $helper->getTabs($course, $courseDiscussions, "new"))) ?>
            <div class="tab-block">
                ...
                <div id="sf_admin_footer">
                    <?php include_partial('tpCourseDiscussion/form_footer', array('course' => $course, 'form' => $form, 'configuration' => $configuration)) ?>
                </div>
            </div>
        </div>
    </div>
