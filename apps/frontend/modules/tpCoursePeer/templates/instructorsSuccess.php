...
<?php include_partial('common/breadcrumbs', $helper->getBreadcrumbs("Instructors", "course/instructors")) ?>
<?php include_partial('common/flashes_normal') ?>
<div id="sf_admin_content">
    <div class="content-block">
        <?php include_partial('common/tabs', array('tabs' => $helper->getTabs("instructors"))) ?>
        <div class="tab-block">
