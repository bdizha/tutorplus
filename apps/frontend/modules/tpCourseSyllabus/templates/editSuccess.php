...
<?php include_partial('tpCommon/breadcrumbs', $helper->getBreadcrumbs($course, $course_syllabus)) ?>
...
<div id="sf_admin_content">
    <div class="content-block">
        <?php include_partial('tpCommon/tabs', array('tabs' => $helper->getTabs($course, "edit", $course_syllabus))) ?>
        <div class="tab-block">
