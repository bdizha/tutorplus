...
<?php if ($discussion): ?>
    <div class="snapshot<?php echo $discussion->getProfileId() == $sf_user->getId() ? " current" : "" ?>">
        <div class="heading">
        ...
        <div class="body">
            ...
            <div class="user-meta">Created by <?php echo link_to($discussion->getProfile(), 'profile_show', $discussion->getProfile()) ?> - <span class="datetime"><?php echo myToolkit::dateInWords($discussion->getCreatedAt()) ?></span></div>
        </div>
