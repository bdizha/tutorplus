<li class="sf_admin_batch_actions_choice">
  <select name="batch_select" class="batch_selects">
    ...
    <option value="batchMarkAsRead"><?php echo __('Mark as read', array(), 'sf_admin') ?></option>
    <option value="batchMarkAsUnread"><?php echo __('Mark as unread', array(), 'sf_admin') ?></option>
  </select>
