<div class="message_stream <?php echo $isFirst ? ' current' : '' ?>" id="message">
    <div class="sf_admin_form_row sf_admin_text sf_admin_form_field_from_email">    
        ...
        <div class="content">
            ...
            <?php include_partial('tpPersonalInfo/photo', array('profile' => $sender, "dimension" => 24)) ?>
    ...
    <div class="thread">
        <?php include_partial('tpPersonalInfo/photo', array('profile' => $emailMessage->getSender(), "dimension" => 48)) ?>
        <div class="message">
    ...
    <?php foreach ($emailMessage->getReplies() as $reply): ?>
        ...
        <div class="thread">
            <?php include_partial('tpPersonalInfo/photo', array('profile' => $emailMessageReply->getSender(), "dimension" => 48)) ?>
            <div class="message">
    ...
    <div class="thread" id="message_reply">
        <form action="/message/reply" method="post" name="message_reply_form" id="message_reply_form">
            ...
            <?php include_partial('tpPersonalInfo/photo', array('profile' => $sf_user->getProfile(), "dimension" => 48)) ?>
            <div class="reply">
