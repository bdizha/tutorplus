...
<?php include_component('common', 'secureMenu', $helper->getEditLinks($news_item)) ?>
<?php include_partial('common/breadcrumbs', $helper->getEditBreadcrumbs($news_item)) ?>
...
<div id="sf_admin_form_container">
	<div id="sf_admin_content">
		<div class="content-block">
			<?php include_partial('common/tabs', array('tabs' => $helper->getTabs($announcements, $newsItems, "edit", $news_item))) ?>
			<div class="tab-block">
