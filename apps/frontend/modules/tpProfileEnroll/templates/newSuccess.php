        ...
        <div class="right-block">
            ...
            <div id="sf_admin_form_container">
                <div id="sf_admin_content">
                    <?php include_partial('tpProfileEnroll/form', array('profile' => $profile, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
                </div>
                <div id="sf_admin_footer">
                    <?php include_partial('tpProfileEnroll/form_footer', array('profile' => $profile, 'form' => $form, 'configuration' => $configuration)) ?>
                </div>
            </div>
        </div>
    </div>
