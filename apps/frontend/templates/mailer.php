...
<html xmlns="http://w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        <div style="width:600px;background-color:#F1F1F1">
            <div style="border-style:solid;border-width:1px;border-color:#F5F5F5;border-bottom:none;padding:10px;height: 40px;overflow: hidden;">
                <img src="http://tutorplus.org/images/logo.png" style="width: 500px;margin-top: -33px;margin-left: -74px;"></img>
            </div>
            <div style="background-color:#fdfdfd;border-style:solid;border-width:1px;border-color:#F5F5F5;padding:20px;color:#505050;font-family:'helvetica neue', helvetica, arial, sans-serif;font-size:12px;line-height:1.8em">
