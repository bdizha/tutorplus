...
// date: 2012/09/09 16:29:38
$response = $this->context->getResponse();

if ($this->actionName.$this->viewName == 'inlineNewSuccess')
{
  $templateName = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_template', $this->actionName);
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
else if ($this->actionName.$this->viewName == 'inlineEditSuccess')
{
  $templateName = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_template', $this->actionName);
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
...
if ($templateName.$this->viewName == 'inlineNewSuccess')
{
  ...
  $response->addStylesheet('ecollegeplus.css', '', array ());
  ...
  $response->addStylesheet('discussion', '', array ());
  $response->addStylesheet('profile', '', array ());
  $response->addStylesheet('student', '', array ());
  $response->addStylesheet('contact', '', array ());
...
else if ($templateName.$this->viewName == 'inlineEditSuccess')
{
  if (null !== $layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout'))
  {
    $this->setDecoratorTemplate(false === $layout ? false : $layout.$this->getExtension());
