...
require_once(dirname(__FILE__).'/../lib/BaseProfileGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseProfileGeneratorHelper.class.php');
 ...
 */
abstract class autoProfileActions extends sfActions
{
  ...
  {
    return $this->getUser()->getAttribute('profile.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('profile.filters', $filters, 'admin_module');
  }
