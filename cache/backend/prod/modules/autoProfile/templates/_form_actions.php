<ul class="sf_admin_actions">
                    ...
                    <?php else: ?>
                    <?php echo link_to(__('Cancel', array(), 'messages'), 'profile/List_cancel?id='.$sf_guard_user->getId(), array()) ?>                    <?php endif; ?>
                </li>
                    ...
                    <?php else: ?>
                    <?php echo link_to(__('Done', array(), 'messages'), 'profile/List_done?id='.$sf_guard_user->getId(), array()) ?>                    <?php endif; ?>
                </li>
                            <?php endif; ?>
</ul>