...
class ##MODULE_NAME##GeneratorHelper extends Base##UC_MODULE_NAME##GeneratorHelper
{
    ...
    {
        return '<li class="sf_admin_action_new">'.button_to(__($params['label'], array(), 'sf_admin'), "/backend.php/##MODULE_NAME##/new", array()).'</li>';
    }

    public function linkToEdit($object, $params)
    {
        return '<li class="sf_admin_action_edit">'.link_to(__('<img src="/images/icons/14x14/edit.png" title="Edit" alt="Edit">', array(), 'sf_admin'), "/backend.php/##MODULE_NAME##/".$object->getId()."/edit").'</li>';
    }
    ...
    {
        return '<input class="cancel" type="button" onclick="document.location.href=\'/backend.php/##MODULE_NAME##\' value="Cancel"/>';
    }
