...
CREATE TABLE activity_feed (id BIGSERIAL, profile_id BIGINT NOT NULL, item_id BIGINT NOT NULL, type BIGINT DEFAULT 0 NOT NULL, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE discussion_topic (id BIGSERIAL, subject VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT 'General' NOT NULL, message TEXT NOT NULL, discussion_id BIGINT NOT NULL, profile_id BIGINT NOT NULL, latest_comment_id BIGINT, view_count BIGINT DEFAULT 0, comment_count BIGINT DEFAULT 0, is_primary BOOLEAN DEFAULT 'false', created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL, slug VARCHAR(255), PRIMARY KEY(id));
...
CREATE TABLE profile (id BIGSERIAL, title VARCHAR(255), first_name VARCHAR(255), last_name VARCHAR(255), middle_name VARCHAR(255), birth_date TIMESTAMP, gender VARCHAR(255), is_instructor BOOLEAN DEFAULT 'false', high_school VARCHAR(255), studied_at VARCHAR(255), current_study VARCHAR(255), email VARCHAR(255), password VARCHAR(255), algorithm VARCHAR(255) DEFAULT 'sha1', salt VARCHAR(255), is_super_admin BOOLEAN DEFAULT 'false', is_active BOOLEAN DEFAULT 'true', institution_id BIGINT DEFAULT 1 NOT NULL, last_login TIMESTAMP, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL, slug VARCHAR(255), PRIMARY KEY(id));
