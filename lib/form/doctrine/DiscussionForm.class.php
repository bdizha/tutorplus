...
class DiscussionForm extends BaseDiscussionForm
{
    ...
    {
        $last_visit = !$this->getObject() ? date("d-m-Y H:i:s", strtotime("now")) : $this->getObject()->getDateTimeObject('last_visit')->format('d-m-Y');
        $this->getObject()->setLastVisit($last_visit);
    }
