    ...
    $.fn.scrollbars = function(method) {
        ...
        var methods = {
            ...
            "prepare": function() {
                ...
                if (xSpace === 'auto') {
                    temp = $("<div/>", {
                        "class": classes['dragCon'] + " scrollElement " + classes['dragCon'] + "X"
                        }).appendTo("body");
                ...
                if (ySpace === 'auto') {
                    temp = $("<div/>", {
                        "class": classes['dragCon'] + " scrollElement " + classes['dragCon'] + "Y"
                        }).appendTo("body");
                ...
                obj.wrapInner($("<div/>", {
                    "class":[classes["contentWrap"], "scrollElement", id].join(" ")
                    }));
                var contentWrap = data.contentWrap = obj.find("." + classes["contentWrap"] + "." + id);

                // Wrap with our root wrap
                obj.wrapInner($("<div/>", {
                    "class": [classes["rootWrap"], "scrollElement", id].join(" ")
                    }));
            ...
            "generate": function(axis) {
                ...
                var dragCon = data[axis].dragCon = $("<div/>", {
                    "class": [classes["scrollElement"], id, classes["dragCon"], classes["dragCon"]+axis].join(" ")
                    }).appendTo(obj);
                ...
                // Create the dragger
                var dragger = data[axis].dragger = $("<div/>", {
                    "class": [classes["scrollElement"], classes["dragger"], id, classes["dragger"] + axis].join(" ")
                    }).appendTo(dragCon);
